  ...
  return (
    <section style={{ background:'#ffffff', padding:'7rem 3rem', textAlign:'center', borderTop:'1px solid #ede9e3' }}>
      <div style={{ maxWidth:'700px', margin:'0 auto' }}>
        ...
        <h2 style={{ fontFamily:'Sora,sans-serif', fontWeight:800, fontSize:'clamp(2rem,5vw,3.5rem)', color:'var(--dark)', letterSpacing:'-0.03em', marginBottom:'1.5rem', lineHeight:1.1 }}>
        ...
        <Link href="/contact"
          ...
          style={{ display:'inline-flex', alignItems:'center', gap:'0.7rem', background: hovered ? 'var(--dark)' : 'var(--red)', color:'white', padding:'1.1rem 2.5rem', fontFamily:'Sora,sans-serif', fontWeight:700, fontSize:'0.95rem', letterSpacing:'0.04em', transition:'all 0.25s ease', borderRadius:'50px', boxShadow: hovered ? '0 8px 30px rgba(61,43,31,0.2)' : '0 8px 30px rgba(249,8,8,0.25)' }}>
          Book a Free Call
